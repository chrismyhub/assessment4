...
awk 'BEGIN { 
    ...
    printf("| \033[34m%-60s\033[0m | \033[34m%-5s\033[0m | \033[34m%-7s\033[0m  |\n", ENTITY, MONTHYEAR, LINK1TITLE); 
    printf("| \033[34m%-60s\033[0m | \033[34m%-6s\033[0m | \033[34m%-7s\033[0m  | \033[34m%-35s\033[0m  |\n", "", "", "", "", "");  
} 
      
{ 

    printf("| \033[33m%-60s\033[0m | \033[35m%-6s\033[0m | \033[35m%-8s\033[0m |\n", $1, $2, $4); 
